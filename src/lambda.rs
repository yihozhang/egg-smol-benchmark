...
//     pub(crate) fn new(n: usize) -> impl Benchmark {
//         RunN { n }
//     }
//     pub struct RunN {
//         n: usize,
...
//             runner = runner
//                 // .with_scheduler(egg::BackoffScheduler::default().with_initial_match_limit(100000))
...
//             log::info!("===== egg =====");
//             log::info!("{}", report);
//             report.egraph_classes + report.egraph_nodes
//         }
